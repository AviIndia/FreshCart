                ...
                <div className="offcanvas-body ps-lg-2 pt-lg-0">
                  ...
                  <div className="mb-8">
                    ...
                    <div className="form-check mb-2">
                      {/*-- input  */}
                      <input className="form-check-input" type="checkbox" defaultValue="" id="eGrocery" checked />
                  ...
                  <div className="mb-8">
                    ...
                    <div>
                      ...
                      <div className="form-check mb-2">
                        {/*-- input  */}
                        <input className="form-check-input" type="checkbox" defaultValue="" id="ratingFour" checked />
            ...
            <section className="col-lg-9 col-md-12">
                ...
                <div className="d-md-flex justify-content-between align-items-center">
                  ...
                  <div className="d-flex mt-2 mt-lg-0">
                    <div className="me-2 flex-grow-1">
                      {/*-- select option  */}
                      <select className="form-select" defaultValue={limit} onChange={handleLimitChange}>
                    ...
                    <div>
                      {/*-- select option  */}
                      <select className="form-select" defaultValue={sortBy} onChange={handleSortChange} >

                        <option defaultValue="featured">Sort by: Featured</option>

                        <option defaultValue="price_low_to_high"> Price: Low to High</option>

                        <option defaultValue="price_high_to_low">Price: High to Low </option>
                      ...
                      <div className="card card-product">
                        <div className="card-body">
                          ...
                          <div className="text-center position-relative">
                            ...
                            <NavLink  to={`/productSingle/${item.category_id}/${item.product_id}`}>
                              <img
                                src={item.thumbnail}
                                alt={item.name}
              ...
              >
                <i className="bi bi-arrow-left-right"></i>
                          ...
                          {/* product name */}
                          <h2 className="fs-6 product-title">
                            <NavLink
                          ...
                          <div className="d-flex justify-content-between align-items-center mt-1">
                            <div>
                              <NavLink onClick={() => {
                                ...
                                addToCart(item, 1);}} className="btn btn-primary btn-sm">
                                Add to cart
                              </NavLink>
                            </div>
                            <div>
                ...
                <div className="col">
                  ...
                  <nav>
                    <ul className="pagination">
                      ...
                      {/* Page Numbers */}
                      {
                        [...Array(pagination.total_pages)].map((_, index) => {
                          ...
                          return (
                            ...
                            >
                              <button
                                className={`page-link mx-1 ${currentPage === page
                                    ? "active"
                                    : ""
                                  }`}
                                onClick={() =>
                      ...
                      {/* Next Button */}
                      <li
                        className={`page-item ${currentPage === pagination.total_pages
                            ? "disabled"
                            : ""
                          }`}
                      >
